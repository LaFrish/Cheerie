...
boredimg = Cheerup.create({name: "bored.gif", img_url: "/assets/bored/bored.gif", data_type: "img", tag: "Bored", feeling: bore})
...
bored3 = Cheerup.create({name: "bored_2.gif", img_url: "/assets/bored/bored_1.gif", data_type: "gif", tag: "Bored", feeling: bore})

bored4 = Cheerup.create({name: "bored_3.gif", img_url: "/assets/bored/bored_1.gif", data_type: "gif", tag: "Bored", feeling: bore})

bored5 = Cheerup.create({name: "bored_4.gif", img_url: "/assets/bored/bored_1.gif", data_type: "gif", tag: "Bored", feeling: bore})
